...
const I18N = {
  ...
  strings: {
    ...
    'pro_modal.secure':   { en: 'Secure payment via Lemon Squeezy. Cancel anytime. 7-day money-back guarantee.',
                              zh: '通过 Lemon Squeezy 安全支付。随时取消。7天无理由退款。',
                              ja: 'Lemon Squeezyによる安全な支払い。いつでもキャンセル可能。7日間返金保証。',
                              ko: 'Lemon Squeezy를 통한 안전한 결제. 언제든지 취소 가능. 7일 환불 보장.' },
